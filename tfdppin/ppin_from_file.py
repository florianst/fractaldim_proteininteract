...
def build_graph_from_ppin_file(fname = "BIOGRID-ORGANISM-Human_Herpesvirus_6B-3.5.165.tab2_duplicate.txt"): # return graph from ppin file, with labels: Interactor IDs
    ...
    # draw graph
    graph = nx.from_pandas_edgelist(df_ppin[[colA_name, colB_name]], colA_name, colB_name)
...
if __name__ == "__main__":
    ...
    if (do_draw):
        ...
        #pos = nx.nx_agraph.graphviz_layout(max_subgraph, prog='sfdp') # this requires pygraphviz - couldn't make it work...
